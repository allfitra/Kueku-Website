            ...
            <div class="row">
                ...
                <div class="row">
                    @foreach ($products as $product)
                        <div class="col-md-3 col-xs-6 mt-3">
                            <div class="card h-100 shadow mb-4 border-radius">
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <a href="{{ route('add_to_cart', $product->id) }}"
                                        class="btn btn-sm btn-block w-100 btn-brown mt-auto"><i class="bi bi-cart-plus"></i>
                                        Add To Cart</a>
                                </div>
                            </div>
                        </div>
